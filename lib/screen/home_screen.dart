...
//   }
//
//   void showPrioritySchedules(BuildContext context, int priority) {
//     showDialog(
//       context: context,
//       builder: (BuildContext context) {
//         final filteredSchedules = schedules.where((schedule) => schedule.priority == priority).toList();
//         return AlertDialog(
...
//                               priority: schedule.priority,  // 중요도 필드 전달
//                             ),
//                           ),
//                         ],
//                       ),
                ...
                child: StreamBuilder<QuerySnapshot>(
                  ...
                  builder: (context, snapshot) {
                    ...
                    return ListView.builder(
                      ...
                      //schedules.where((schedule) => schedule.priority == 3)
                      /* 여기부터 */
                      // test_schedules = schedules.where((schedule) => schedule.priority == 3).toList();
