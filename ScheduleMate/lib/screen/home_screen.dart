...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void addItemToList() {
    // 리스트에 아이템 추가하는 함수
    setState(() {
      items.insert(0, "New Item ${items.length + 1}");  // 새 아이템을 리스트의 시작부분에 추가
    });
  }
    ...
    return Scaffold(
      floatingActionButton: FloatingActionButton(
        ...
        onPressed: () {
          ...
          logger.d('MyLog' + '${selectedDate.year}${selectedDate.month.toString().padLeft(2, '0')}${selectedDate.day.toString().padLeft(2, '0')}');
          // logger.d("aa" + result);
          // addItemToList();
        },
        child: Icon(
